...
export default function ProjectDetail() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Cientifiks en Joc es una plataforma web educativa que ofrece juegos y actividades para que los niños aprendan ciencia de forma divertida. Los usuarios pueden registrarse y acceder a diferentes juegos y actividades educativas, que han sido diseñadas para fomentar el aprendizaje de conceptos científicos de forma interactiva y entretenida. La plataforma ha sido desarrollada utilizando HTML, CSS, PHP, JavaScript y MySQL, y cuenta con un diseño atractivo y colorido que resulta atractivo para los más pequeños. Además, se ha integrado un sistema de gestión de usuarios y un panel de administración para que los profesores puedan supervisar el progreso de sus alumnos y asignar tareas y actividades.',
      img: './projects-img/ctfj-main.png',
      imgs: ['./projects-img/ctfjk-1.jpg', './projects-img/ctfjk-2.jpg', './projects-img/ctfjk-3.jpg', './projects-img/ctfjk-4.jpg', './projects-img/ctfjk-5.jpg', './projects-img/ctfjk-6.jpg', './projects-img/ctfjk-7.jpg',],
      año: 'Octubre 2023 - Diciembre 2023',
      video: './projects-videos/ctfk-video.mp4',
    },
    // {
    //   title: 'FilmZ',
    //   category: 'Desktop & Mobile',
    ...
    <div className='normal-width-section'>
      <div className='project-container'>
        ...
        <div className='links-project-container d-flex flex-row'>
          { project.github && <a href={project.github} className='project-link-github'>
